...
for ids, recording in enumerate(recording_list):
    ...
    #     debug.error("No MRSI to T1W found")
    #     continue
    ...
    simmatrix_sp, pvalue_sp,parcel_concentrations   = parc.compute_simmatrix(mrsirand,parcel_mrsi_np,parcel_header_dict,parcel_label_ids_ignore,N_PERT,corr_mode = "spearman",rescale="zscore")
    ...
    simmatrix_sp_leave_out      = parc.leave_one_out(simmatrix_sp,mrsirand,parcel_mrsi_np,parcel_header_dict,parcel_label_ids_ignore,N_PERT,corr_mode = "spearman",rescale="zscore")
    ...
    try:    
        ...
        simplt.plot_simmatrix(simmatrix_sp,ax=axs[0],titles=f"{prefix} Spearman Z-Norm",
                            scale_factor=0.4,
                            parcel_ids_positions=parcel_ids_positions,
                            colormap="magma",show_parcels="H") 
        simplt.plot_simmatrix(simmatrix_mi,ax=axs[1],titles=f"{prefix} MI",
                            scale_factor=0.4,
                            parcel_ids_positions=parcel_ids_positions,
